...
The L<unspace|#unspace> C<\> operator allows language extensibility by telling the compiler's lexer to ignore contiguous whitespace.

    # An unspace operator can be used to line up postfix operators. 
